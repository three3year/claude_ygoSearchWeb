...
BATCH = os.path.join(ROOT, ".scratch", "tag-card", "batches", "kind-04.json")
OUT = os.path.join(ROOT, ".scratch", "tag-card", "judgments", "kind-04.json")
...
from _speckind04 import fill  # noqa: E402
