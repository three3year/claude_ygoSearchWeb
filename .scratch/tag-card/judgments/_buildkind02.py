...
BATCH = os.path.join(ROOT, ".scratch", "tag-card", "batches", "kind-02.json")
OUT = os.path.join(ROOT, ".scratch", "tag-card", "judgments", "kind-02.json")
...
from _speckind02 import fill  # noqa: E402
