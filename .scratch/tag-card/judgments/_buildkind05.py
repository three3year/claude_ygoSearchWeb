...
BATCH = os.path.join(ROOT, ".scratch", "tag-card", "batches", "kind-05.json")
OUT = os.path.join(ROOT, ".scratch", "tag-card", "judgments", "kind-05.json")
...
from _speckind05 import fill  # noqa: E402
