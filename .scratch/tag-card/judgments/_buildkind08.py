...
BATCH = os.path.join(ROOT, ".scratch", "tag-card", "batches", "kind-08.json")
OUT = os.path.join(ROOT, ".scratch", "tag-card", "judgments", "kind-08.json")
...
from _speckind08 import fill  # noqa: E402
