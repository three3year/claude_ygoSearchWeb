...
BATCH = os.path.join(ROOT, ".scratch", "tag-card", "batches", "kind-01.json")
OUT = os.path.join(ROOT, ".scratch", "tag-card", "judgments", "kind-01.json")
...
from _speckind01 import fill  # noqa: E402
