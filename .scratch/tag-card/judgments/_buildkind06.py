...
BATCH = os.path.join(ROOT, ".scratch", "tag-card", "batches", "kind-06.json")
OUT = os.path.join(ROOT, ".scratch", "tag-card", "judgments", "kind-06.json")
...
from _speckind06 import fill  # noqa: E402
