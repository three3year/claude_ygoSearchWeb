...
BATCH = os.path.join(ROOT, ".scratch", "tag-card", "batches", "kind-09.json")
OUT = os.path.join(ROOT, ".scratch", "tag-card", "judgments", "kind-09.json")
...
from _speckind09 import fill  # noqa: E402
